...
### Responsive, Mobile ready, Horizontal/Vertical views
...
* Fix   - Fixed bug with Grouped product prices and Custom Field Numeric filter
...
* Fix   - Fixed bug with Custom Field Numeric prefix that contains "_" symbol at the beginning
