...
if ( ! class_exists( 'acf_pro_updates' ) ) :
	...
	class acf_pro_updates {
		...
		public function init() {
			// Test mode: completely disable license checks and plugin update registration.
			return;
		}
...
function acf_pro_get_license() {
	// Test mode: zwracamy sztuczną, zawsze poprawną licencję.
	return array(
		'key' => 'TEST-ACF-PRO-LICENSE-KEY',
...
function acf_pro_is_license_active( $status = array() ) {
	// Test mode override: always treat license as active.
	return true;
}
