...
namespace FSProVendor\WPDesk\Plugin\Flow;
...
{
    const LIBRARY_TEXT_DOMAIN = 'flexible-shipping-pro';
     ...
     */
    private function init_translations(\FSProVendor\WPDesk_Plugin_Info $plugin_info)
    {
        $lang_dir = 'lang';
    ...
    private function create_requirements_checker()
    {
        ...
        $requirements_checker_factory = new \FSProVendor\WPDesk_Basic_Requirement_Checker_Factory();
    ...
    {
        $plugin_info = new \FSProVendor\WPDesk_Plugin_Info();
