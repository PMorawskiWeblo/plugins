...
?>
    ...
    private static function get_empty_field_group_notice_html()
    {
        ...
        <div class="acftc-notice acftc-notice--empty-field-group">
            <p><?php _e('To generate theme code, create some fields and then publish the field group.', 'acf-bober-code'); ?></p>
        </div>
    ...
    /**
     * Get HTML for upgrade notice (disabled in this fork)
     * 
     * @return string 
     */
    private static function get_upgrade_notice_html()
    {
        // No external upgrade / marketing notice in ACF Bober Code
        return '';
    }
}
