...
final class ACFTC_Core
{
	 ...
	 * 
	 * Jeśli wersja ACF < 6 użyj arkusza legacy
	 */
	private function get_stylesheet_filename()
	{
		// Nazwy plików CSS pozostają jak w oryginalnej wtyczce:
		// assets/acf-theme-code.css oraz assets/acf-theme-code-legacy.css
	...
	public function enqueue($hook)
	{
		...
		if (
			...
			// Plugin JS (zachowujemy oryginalną nazwę pliku JS)
			...
			wp_set_script_translations('acftc', 'acf-bober-code', $translation_dir_file_path);
		...
		if ( $current_screen && ACFTC_IS_PRO && 'settings_page_theme-code-pro-license' === $current_screen->id ) {
	...
	public function load_textdomain()
	{
		...
		load_plugin_textdomain('acf-bober-code', false, dirname(ACFTC_PLUGIN_BASENAME) . '/pro/languages');
	}
}
