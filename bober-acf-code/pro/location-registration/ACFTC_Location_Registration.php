...
class ACFTC_Location_Registration extends ACF_Admin_Tool
{
	...
	function initialize()
	{
		...
		$this->title = __('Bober Code', 'acf-bober-code');
	}
...
?>
		...
		<div class="acf-postbox-inner">
			...
			<h4 class="acftc-registration-tool-title"><?php _e('Register ACF Blocks or Options Pages', 'acf-bober-code'); ?></h4>
			...
			<div class="acftc-tool-inputs">
				...
				<div class="acftc-field acftc-field--top">
					...
					<div class="acftc-label">
						<label for="acftc-registration-option"><?php _e('Location', 'acf-bober-code'); ?></label>
					</div>
					...
					<div class="acftc-input">
						<select id="acftc-registration-option" class="" data-ui="0" data-ajax="0" data-multiple="0" data-placeholder="Select" data-allow_null="0">
							<option value="acftc-register-block"><?php _e('Block', 'acf-bober-code'); ?></option>
							<option value="acftc-register-options"><?php _e('Options', 'acf-bober-code'); ?></option>
						</select>
					</div>
				...
				<div id="acftc-register-block" class="acftc-registration-wrap acftc-registration-wrap--active">
					...
					<div class="acftc-tool-inputs">
						...
						<div class="acftc-field acftc-field--name">
							...
							<div class="acftc-label">
								<label><?php _e('Block Name', 'acf-bober-code'); ?></label>
							</div>
						...
						<div class="acftc-block-code-hidden">add_action( 'acf/init', 'register_<span class="acf-tc-block-name--lower-underscores">example</span>_block' );
							...
							// <?php _e('Register', 'acf-bober-code'); ?> <span class="acf-tc-block-name--raw">Example</span> <?php _e('block', 'acf-bober-code'); ?>

							acf_register_block_type( array(
							'name' => '<span class="acf-tc-block-name--lower-dashes">example</span>',
							'title' => __( '<span class="acf-tc-block-name--raw">Example</span>' ),
							'description' => __( '<?php _e('A custom', 'acf-bober-code'); ?> <span class="acf-tc-block-name--raw">Example</span> <?php _e('block', 'acf-bober-code'); ?>.' ),
							'category' => 'formatting',
							'icon' => 'layout',
						...
						<div class="acftc-field-meta acftc-field-meta--registration">
							<span class="acftc-field-meta__title" data-type="link" data-pseudo-content="<?php _e('Register a Gutenberg Block', 'acf-bober-code') ?>"></span>
						</div>

						<div id="acftc-block-code-output" class="acftc-field-code">
							<a href="#" class="acftc-field__copy acftc-field__copy--registration acf-js-tooltip" title="<?php _e('Copy to clipboard', 'acf-bober-code') ?>"></a>
				...
				<div id="acftc-register-options" class="acftc-registration-wrap">
					...
					<div class="acftc-tool-inputs">
						...
						<div class="acftc-field acftc-field--name">
							...
							<div class="acftc-label">
								<label><?php _e('Page Name', 'acf-bober-code') ?></label>
							</div>
						...
						<div class="acftc-field-meta acftc-field-meta--registration">
							<span class="acftc-field-meta__title" data-type="link" data-pseudo-content="<?php _e('Register an Options Page', 'acf-bober-code') ?>"></span>
						</div>
	...
	function meta_box_header_html()
	{
		...
		$tool_tip =  sprintf(
			...
			__('The code generated below will need to be included in your %s file (or similar).', 'acf-bober-code'),
			'functions.php'
		);
